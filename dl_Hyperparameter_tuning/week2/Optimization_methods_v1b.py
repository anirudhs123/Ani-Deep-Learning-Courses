...
def initialize_velocity(parameters):
    ...
    for l in range(L):
        ### START CODE HERE ### (approx. 2 lines)
        m=parameters["W" + str(l+1)].shape[0]
        n=parameters["W" + str(l+1)].shape[1]
        m1=parameters["b" + str(l+1)].shape[0]
        n1=parameters["b" + str(l+1)].shape[1]
        v["dW" + str(l+1)] = np.zeros((m,n),dtype=float)
        v["db" + str(l+1)] = np.zeros((m1,n1),dtype=float)
        ### END CODE HERE ###
...
def initialize_adam(parameters) :
    ...
    ### START CODE HERE ### (approx. 4 lines)
        ...
        v["dW" + str(l+1)] = np.zeros((m,n),dtype=float)
        v["db" + str(l+1)] = np.zeros((m1,n1),dtype=float)
        s["dW" + str(l+1)] = np.zeros((m,n),dtype=float)
        s["db" + str(l+1)] = np.zeros((m1,n1),dtype=float)
    ### END CODE HERE ###
...
def update_parameters_with_adam(parameters, grads, v, s, t, learning_rate = 0.01,
    ...
    for l in range(L):
        ...
        ### START CODE HERE ### (approx. 2 lines)
        v["dW" + str(l+1)] =  (1-beta1)*grads['dW' + str(l+1)]+beta1*(v["dW" + str(l+1)])
        v["db" + str(l+1)] =  (1-beta1)*grads['db' + str(l+1)]+beta1*(v["db" + str(l+1)])
        ...
        ### START CODE HERE ### (approx. 2 lines)
        s["dW" + str(l+1)] = (1-beta2)*(grads['dW' + str(l+1)]*grads['dW' + str(l+1)])+beta2*(s["dW" + str(l+1)])
        s["db" + str(l+1)] = (1-beta2)*(grads['db' + str(l+1)]*grads['db' + str(l+1)])+beta2*(s["db" + str(l+1)])
        ### END CODE HERE ###
