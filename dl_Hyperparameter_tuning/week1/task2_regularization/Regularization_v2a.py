...
def compute_cost_with_regularization(A3, Y, parameters, lambd):
    ...
    L2_regularization_cost = lambd*(np.sum(np.square(W1))+np.sum(np.square(W2))+np.sum(np.square(W3)))*(1/2)*(1/m)
    ### END CODER HERE ###
...
def backward_propagation_with_regularization(X, Y, cache, lambd):
    ...
    ### START CODE HERE ### (approx. 1 line)
    dW3 = 1./m * np.dot(dZ3, A2.T) + lambd*(1/m)*W3
    ### END CODE HERE ###
    ...
    ### START CODE HERE ### (approx. 1 line)
    dW2 = 1./m * np.dot(dZ2, A1.T) + lambd*(1/m)*W2
    ### END CODE HERE ###
    ...
    ### START CODE HERE ### (approx. 1 line)
    dW1 = 1./m * np.dot(dZ1, X.T) + lambd*(1/m)*W1
    ### END CODE HERE ###
